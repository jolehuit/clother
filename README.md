...
# 2. Install Clother
curl -fsSL https://raw.githubusercontent.com/sam-fakhreddine/clother/main/clother.sh | bash
```
...
```bash
# Using --bin-dir flag
curl -fsSL https://raw.githubusercontent.com/sam-fakhreddine/clother/main/clother.sh | bash -s -- --bin-dir ~/.local/bin
